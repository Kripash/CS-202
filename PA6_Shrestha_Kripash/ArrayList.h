...
class ArrayList{
  public:
    ...
    DataType* find(const DataType& target, DataType* &previous, const DataType* const start = NULL);

   const DataType* find(const DataType& target, const DataType* &previous,const DataType* const start = NULL)    const ;		        //(9b)
